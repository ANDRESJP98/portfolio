...
const projectsData = [
  {
    id: "Enel X Colombia",
    imgSrc: [EnelXCol,Simulator,Overview,Comsuptions, HistoricalBills, Payment, Users, API, Data, Solicitud, Admin, pythonWeb, React,AWS, pageViews,  pageViews, NPS],
    ...
    {
      id: "AI Chatbot",
      imgSrc: [Chatbot, Chatbot, Chatbot, Chatbot, Dialogflow, Efficiency],
      title: "AI Chatbot",
      ...
      texts: [
        ...
        },
        {
          ...
          description: "This path serves existing customers by providing tailored assistance. Users can inquire about their accounts, current services, comsuptions and billing information, facilitating quicker resolutions to common issues without needing to speak to a representative.",
        },
        {
