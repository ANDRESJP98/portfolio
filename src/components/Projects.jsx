...
return (
  ...
  <div className="container mx-auto font-family-arial mt-10 sm:mt-20 text-center">
    ...
    <div className="card-container flex flex-col sm:flex flex-col md:flex-row lg:flex items-center">
      <div className="m-4 bg-white border-2 border-black rounded-2xl w-80 h-85 sm:h-85 md:h-96 transform transition-transform hover:scale-105">
      ...
      <div className="m-4 bg-white border-2 border-black rounded-2xl w-80 h-85 sm:h-85 md:h-96 transform transition-transform hover:scale-105">
        <a href='https://portfolio-h6nj1yoz6-andresjp98.vercel.app/#aboutme' className="flex flex-col items-center p-5">
        ...
        <div className="flex items-center justify-center -mt-6">
          <h1 className="text-3xl sm:text-3xl md:text-3xl lg:text-4xl font-bold text-black">GitHub</h1>
          <a className="flex flex-col items-end p-5 relative" href='https://github.com/ANDRESJP98/portfolio'>
            <img height='30px' width='30px' src='https://icones.pro/wp-content/uploads/2021/06/icone-github-noir.png' alt="GitHub" />
          </a>
        </div>
      </div>
      <div className="m-4 bg-white  border-2 border-black rounded-2xl w-80 h-85 sm:h-85 md:h-96 transform transition-transform hover:scale-105">
        <a href='https://pokemon-front-6si4.vercel.app/' className="flex flex-col items-center p-5">
